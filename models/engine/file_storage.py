...
# -*- coding: utf-8 -*-
"""File Storage Module
Module in charge of the storage of the
...
class FileStorage:
    ...
    File Storage module.
    Attributes:
        __file_path (str):Path of the JSON file storing
            the contents of the `__objects` variable.
    ...
    def new(self, obj):
        ...
        Args:
            obj (inst): Object that adds in the `__objects` class attribute
    ...
    def save(self):
        ...
        Contents of `__objects` class attribute will be serialized
