...
This module establishes a reference
Base Model for the rest of the classes of the
HBNB project (Airbnb Clone), from which it will be possible
to extract all information eg: A unique universal identifier,
the date and time in which a class was created and updated,
a standard format to print the class content, saving
the data created from the instances and the representation
of all the keys and values of any instance.
...
class BaseModel:
    ...
    This is the Base Model it takes care of the
    ...
    def save(self):
        ...
        with the current datetime dumping the class data
        into a file
